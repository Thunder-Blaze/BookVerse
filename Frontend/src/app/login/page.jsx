            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center space-y-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <i>Terms and Conditions</i> • <i>Privacy Policy</i>
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  New user?{' '}
                  <Link href="/signup" className="text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300">
                    Sign up
                  </Link>
                </p>
              </div>
