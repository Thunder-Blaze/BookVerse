    ...
    <nav className="fixed top-0 left-0 right-0 h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm z-50">
      <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <img src="/icon.png" alt="Website logo" className="h-8 w-auto dark:invert" />
        </div>
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          >
            {theme === 'dark' ? (
              <Sun className="w-5 h-5 text-gray-500" suppressHydrationWarning/>
            ) : (
              <Moon className="w-5 h-5 text-gray-500" suppressHydrationWarning/>
            )}
          </button>
